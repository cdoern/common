...
type manager struct {
	...
	setDev  func(path string, r *configs.Resources) error
}
...
func (m *manager) SetupDevFn(fn func(path string, r *configs.Resources) error) {
	m.setDev = fn
}
...
func (m *manager) Set(r *configs.Resources) error {
	...
	if m.setDev == nil && len(r.Devices) > 0 {
		return cgroups.ErrNoDevRules
	}
